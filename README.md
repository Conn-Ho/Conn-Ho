...
- 🔧 **[opencli](https://github.com/jackwener/opencli)** — Contributed WeRead (微信读书) CLI adapter: fixed API endpoints, arg parsing bugs, and test coverage. [PR #433](https://github.com/jackwener/opencli/pull/433)
